...
<html lang="en">
    ...
    <!-- Site Metas -->
    <title>Contact AT - BlogTravel</title>
    <meta name="keywords" content="">
    <meta name="description" content="">
    <meta name="author" content="">
    
    <!-- Site Icons -->
    <link rel="shortcut icon" href="BlogTravel/images/favicon.ico" type="image/x-icon" />
    <link rel="apple-touch-icon" href="BlogTravel/images/apple-touch-icon.png">
                ...
                <nav class="navbar navbar-inverse navbar-toggleable-md">
                    ...
                    <div class="collapse navbar-collapse justify-content-md-center" id="Forest Timemenu">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link color-green-hover" href="index.php?admin=userBlog&mod=home&act=listPost">Blog Travel</a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="contact">
                        <div class="avatar">
                            <img src="public/img/avatar/<?= $_SESSION['auth']['avatar']?>" alt="">
                        </div>
                        <div class="infor">
                            <h3>Họ tên: <?= $_SESSION['auth']['name']?></h3>
                ...
                <div class="col-md-7">
                    <div id="">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3724.6923309160684!2d105.93059461476282!3d21.004966686011343!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135a8d22485051d%3A0x5cb2530a1a6b6c0!2zSOG7jWMgVmnhu4duIE7DtG5nIE5naGnhu4dwIFZp4buHdCBOYW0!5e0!3m2!1svi!2s!4v1619088157910!5m2!1svi!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container">
            <div class="row">
                 <div id="" class="col-md-12">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3724.6923309160684!2d105.93059461476282!3d21.004966686011343!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135a8d22485051d%3A0x5cb2530a1a6b6c0!2zSOG7jWMgVmnhu4duIE7DtG5nIE5naGnhu4dwIFZp4buHdCBOYW0!5e0!3m2!1svi!2s!4v1619088157910!5m2!1svi!2s" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                    </div>
            </div>
        </div>
   ...
   <!-- MAP & CONTACT -->
    <script src="BlogTravel/js/garden-map.js"></script>
