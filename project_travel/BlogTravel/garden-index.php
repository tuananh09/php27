        ...
        <div class="header-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="logo">
                            <a href="index.php?admin=userBlog&mod=home&act=list"><img src="BlogTravel/images/version/logo.png" alt=""></a>
                        </div><!-- end logo -->
                    </div>
                </div><!-- end row -->
            </div><!-- end header-logo -->
                ...
                <div class="masonry-blog clearfix">
                    ...
                    <div class="center-side">
                        <div class="masonry-box post-media">
                             <img src="public/img/postImg/<?= $value['thumbnail'] ?>" alt="" class="img-fluid img-post">
                             <div class="shadoweffect">
                                <div class="shadow-desc">
                                    <div class="blog-meta">
                                        <span class="bg-aqua"><a href="" title=""><?= $value['category_name'] ?></a></span>
                                        <h4><a href="index.php?admin=userBlog&mod=home&act=detail&id=<?= $value['id'] ?>" title=""><?= $value['title'] ?></a></h4>
                                        <small><a href="index.php?admin=userBlog&mod=home&act=detail&id=<?= $value['id'] ?>" title=""><?= date('d F, Y (l)', strtotime($value['created_at'])) ?></a></small>
                            ...
                            <div class="blog-list clearfix">
                                ...
                                ?>
                                    ...
                                    <div class="blog-meta big-meta col-md-8">
                                        ...
                                        <small><a href="garden-category.php" title=""><i class="fa fa-eye"></i><?= $value['view_count']?></a></small>
                                        <small><a href="garden-single.php" title=""><?= date('d F, Y (l)', strtotime($value['created_at'])) ?></a></small>
                                        <small><a href="#" title="">by <?= $value['user_name']?></a></small>
                                    </div><!-- end meta -->
                                </div><!-- end blog-box -->
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <div class="widget">
                            <div class="footer-text text-center">
                                <a href="index.php?admin=userBlog&mod=home&act=list"><img src="" alt="" class="img-fluid"></a>
